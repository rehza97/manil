...
async def get_lifetime_value(
    ...
    return await generate_report_response(
        db, data, "reports/customers/lifetime_value.html", "Customer Lifetime Value", format, "lifetime_value",
        export_details_key="details",
        generated_by=current_user.id,
        start_date=start,
        end_date=end,
        report_type="customers_customer_lifetime_value",
...
async def get_segmentation(
    ...
    return await generate_report_response(
        db, data, "reports/customers/segmentation.html", "Customer Segmentation", format, "segmentation",
        export_details_key="details",
        generated_by=current_user.id,
        start_date=start,
        end_date=end,
        report_type="customers_customer_intelligence",
...
async def get_kyc_compliance(
    ...
    return await generate_report_response(
        db, data, "reports/customers/kyc_compliance.html", "KYC Compliance", format, "kyc_compliance",
        export_details_key="details",
        generated_by=current_user.id,
        start_date=start,
        end_date=end,
        report_type="customers_kyc_compliance",
        description="KYC compliance and verification",
    )
...
async def get_churn_analysis(
    ...
    return await generate_report_response(
        db, data, "reports/customers/churn_analysis.html", "Churn Analysis", format, "churn_analysis",
        export_details_key="details",
        generated_by=current_user.id,
        start_date=start,
        end_date=end,
        report_type="customers_customer_churn_risk",
