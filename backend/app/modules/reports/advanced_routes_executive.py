...
async def get_kpi_dashboard(
    ...
    return await generate_report_response(db, data, "reports/executive/kpi_dashboard.html", "KPI Dashboard", format, "kpi_dashboard", export_details_key="details", generated_by=current_user.id)
