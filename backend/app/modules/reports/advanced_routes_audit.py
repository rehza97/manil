...
async def get_user_activity(
    ...
    return await generate_report_response(
        db, data, "reports/audit/user_activity.html", "User Activity", format, "user_activity",
        export_details_key="details",
        generated_by=current_user.id,
        start_date=start,
        end_date=end,
        report_type="audit_user_activity",
...
async def get_security_events(
    ...
    return await generate_report_response(
        db, data, "reports/audit/security_events.html", "Security Events", format, "security_events",
        export_details_key="details",
        generated_by=current_user.id,
        start_date=start,
        end_date=end,
        report_type="audit_security_events",
...
async def get_data_changes(
    ...
    return await generate_report_response(
        db, data, "reports/audit/data_changes.html", "Data Change Audit", format, "data_changes",
        export_details_key="details",
        generated_by=current_user.id,
        start_date=start,
        end_date=end,
        report_type="audit_audit_trail",
        description="System audit log and changes",
    )
...
async def get_compliance(
    ...
    return await generate_report_response(
        db, data, "reports/audit/compliance.html", "Regulatory Compliance", format, "compliance",
        export_details_key="by_action",
        generated_by=current_user.id,
        start_date=start,
        end_date=end,
